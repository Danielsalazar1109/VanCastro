...
const ReviewCard = ({ review, index, rowId }: { review: Review; index: number; rowId: string }) => {
    ...
    // Función para formatear la fecha de ISO a formato legible
    ...
    return (
        ...
        >
            <div className="flex justify-between items-start">
                ...
                <Link href={review.link} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    <Image 
    ...
    return (
        <div className="relative overflow-hidden bg-gray-100 p-4 rounded-xl shadow-lg">
            ...
            <div className="relative py-2">
                ...
                <div className="absolute left-[-2%] top-0 w-32 h-full bg-gradient-to-r from-white to-transparent z-10"></div>
                <div className="absolute right-[-2%] top-0 w-32 h-full bg-gradient-to-l from-white to-transparent z-10"></div>
            </div>
            ...
            {/* Animaciones de Tailwind y CSS personalizado */}
            <style>{
                `
                @keyframes marquee {
