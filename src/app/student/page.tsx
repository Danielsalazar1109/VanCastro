        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          ...
          <div className="p-6 border-b">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/booking" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                <h3 className="font-medium text-lg">Book a Lesson</h3>
                <p className="text-gray-600">Schedule your next driving lesson</p>
              </Link>
              <Link href="/" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                <h3 className="font-medium text-lg">View Plans</h3>
                <p className="text-gray-600">Explore our driving lesson packages</p>
              </Link>
              <Link href="/" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
          ...
          <div className="p-6">
            <h2 className="text-xl font-semibold mb-4">Your Upcoming Lessons</h2>
            <div className="bg-gray-50 p-6 rounded-lg text-center">
              <p className="text-gray-600">You don't have any upcoming lessons scheduled.</p>
              <Link href="/booking" className="mt-2 inline-block px-4 py-2 bg-brand-yellow text-brand-dark rounded-md hover:bg-brand-yellow-hover transition">
                Book a Lesson
              </Link>
            </div>
          </div>
