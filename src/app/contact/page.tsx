  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto px-4 mb-8">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6">
          <h2 className="text-3xl font-bold text-left mb-4">Contact us</h2>
          <p className="text-xl text-left mb-6">Monday to Friday from 8a.m.-6p.m.</p>
          <div className="flex items-center mb-4 bg-yellow-50 p-3 rounded-lg">
            <div className="bg-black rounded-full p-2 mr-3">
              <Phone className="h-10 w-10 text-yellow-400 px-1" />
            </div>
            <div>
              <p className="text-lg">+1 604-600-9173</p>
              <p className="text-lg">+1 778-680-5613</p>
            </div>
          </div>
          <div className="flex items-center mb-4 bg-yellow-50 p-3 rounded-lg">
            <div className="bg-black rounded-full p-2 mr-3">
              <Mail className="h-10 w-10 text-yellow-400 px-1" />
            </div>
            <div>
              <p className="text-lg">vancastrodrivingschool@gmail.com</p>
            </div>
          </div>
          <div className="flex items-start mb-4 bg-yellow-50 p-3 rounded-lg">
            <div className="bg-black rounded-full p-2 mr-3 mt-1">
              <MapPin className="h-10 w-10 text-yellow-400 px-1" />
            </div>
            <div>
              <p className="text-xl">Vancouver, North Vancouver, Surrey, Burnaby</p>
            </div>
          </div>
          <div className="mt-6">
            <h3 className="text-center font-semibold mb-4 text-xl">Visit Our Social media</h3>
            <div className="flex justify-center space-x-3">
              <Link href="https://www.facebook.com/p/Vancastro-Driving-School-100088028419878/" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full p-2">
                <Facebook className="h-10 w-10 text-yellow-400 px-1" />
              </Link>
              <Link href="https://www.instagram.com/vancastro_drivingschool/" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full p-2">
                <Instagram className="h-10 w-10 text-yellow-400 px-1" />
              </Link>
              <Link href="https://www.youtube.com/@VanCastro_Driving_School" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full p-2">
                <Youtube className="h-10 w-10 text-yellow-400 px-1" />
              </Link>
              <Link href="#" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full p-2">
                <MessageCircle className="h-10 w-10 text-yellow-400 px-1" />
              </Link>
            </div>
          </div>
        </div>
    ...
    {/* Mobile Icbc Contact Card */}
    <div className="w-full max-w-md mx-auto px-4 mb-8">
      <div className="bg-white rounded-lg shadow-md overflow-hidden border border-blue-200 border-dashed">
        <div className="p-6">
          <h2 className="text-3xl font-bold text-center mb-1">Need help with the</h2>
          <h2 className="text-3xl font-bold text-center mb-2">ICBC Knowledge Test?</h2>
          <p className="text-center mb-6 text-xl">Connect with Our Partner!</p>
          <div className="flex items-center mb-4">
            <div className="bg-black rounded-full p-2 mr-3">
              <Phone className="h-10 w-10 text-yellow-400 px-1" />
            </div>
            <div>
              <p className="text-md">+1 (236) 515-2741</p>
            </div>
          </div>
          <div className="flex items-center mb-6">
            ...
            <div>
              <p className="text-md break-all">icbcknowledgetestmaterial@gmail.com</p>
            </div>
          </div>
          <div>
            <h3 className="text-center font-semibold mb-3 text-xl">Social media</h3>
            <div className="flex justify-center space-x-3">
              <Link href="#" target="_blank" rel="noopener noreferrer" className="bg-black rounded-full p-2">
                <Facebook className="h-10 w-10 text-yellow-400 px-1" />
              </Link>
    ...
    {/* Mobile Contact Form */}
    <div className="w-full max-w-md mx-auto px-4 bg-yellow-50 p-3 rounded-lg">
    <h2 className="text-3xl font-bold mb-1 text-center">Question ?</h2>
    <p className="text-3xl  font-bold mb-8 text-center">Let us know !</p>
    <ContactForm />
    </div>
    </div>
          ...
          <div className="w-full md:w-1/2 max-w-lg">
            <div className="border border-yellow-400 border-2 rounded-lg p-8 bg-white shadow-md">
              ...
              <div className="mb-6 flex flex-row space-x-1">
                ...
                <span className="inline font-extrabold">|</span>
                <a href="mailto:Vancastroadmi@gmail.com" className="hover:text-yellow-600" >
              ...
              <div className="mb-6 flex flex-row space-x-1">
               ...
               <span className="inline font-extrabold">|</span>
               <p className="hover:text-yellow-600">Monday to Friday 8a.m. - 6p.m.</p>
              </div>
              <div className="mb-6">
