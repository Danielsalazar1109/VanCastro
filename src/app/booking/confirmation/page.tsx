...
const CountdownTimer = ({ createdAt }: { createdAt: string }) => {
	...
	return <span className="text-4xl text-red-500 font-bold">Time Remaining: {timeRemaining}</span>;
};
			...
			<div className="bg-white p-8 rounded-lg shadow-md">
				<div className="text-center mb-8">
					...
					<p className="text-red-600 text-lg">
						You can make the payment through an e-Transfer to the following account:
